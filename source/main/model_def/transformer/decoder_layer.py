...
class DecoderLayer(nn.Module):
    ...
    def forward(self, encoder_output,  word_input, look_ahead_mask, source_padding_mask, *input):
        """
        ...
        attn1, attn_weights_block1 = self.mha1(word_input, word_input, word_input, mask=look_ahead_mask)
